      ...
      <div className="card-container">
        <div className="card-content w-327 h-543 rounded-[15px] bg-very-dark-blue-card p-6 flex flex-col gap-6 xl:w-350 xl:h-596 xl:pb-8">
          <div className="content-image relative w-278 h-278 overflow:hidden rounded-[8px] xl:w-302 xl:h-302">
            <img className="w-full h-full hover:bg-cyan hover:opacity-50 hover:cursor-pointer" src="https://francinehuang.github.io/nft-preview-card-component-react/images/image-equilibrium.jpg" loading="lazy" decoding="async" alt="Equilibrium" />
          ...
          <div className="content-main flex flex-col gap-4 xl:gap-6">
            <div className="main-description flex flex-col gap-3">
              <h1 className="text-white text-22 leading-28 font-semibold hover:text-cyan focus:text-cyan active:text-cyan hover:cursor-pointer" tabIndex={0}>Equilibrium #3429</h1>
              <p className="text-soft-blue text-18 leading-26 font-light">Our Equilibrium collection promotes balance and calm.</p>
            </div>

            <div className="main-value flex justify-between">
              <div className="value text-cyan flex items-center">
                <h2 className="text-15 font-semibold leading-19 ml-[6.48px] xl:text-16 xl:leading-20">0.041 ETH</h2>
              </div>
            ...
            <div className="main-avatar flex gap-4">
              <div className="avatar-container w-33 h-33 rounded-full border-[1px] border-white overflow-hidden">
                <img className="w-full h-full hover:bg-cyan hover:cursor-pointer" src="https://francinehuang.github.io/nft-preview-card-component-react/images/image-avatar.png" loading="lazy" decoding="async" alt="Equilibrium" />
              </div>

              <div className="main-author flex items-center gap-[5px]">
                <p className="text-soft-blue text-15 leading-19 xl:text-16 xl:leading-20">
                  Creation of
                </p>
                <span className="text-white text-15 leading-19 xl:text-16 xl:leading-20 hover:text-cyan focus:text-cyan hover:cursor-pointer" tabIndex={0}>
                  Jules Wyvern
                </span>
              </div>
            </div>          
